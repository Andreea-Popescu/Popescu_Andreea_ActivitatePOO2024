...
int main() {
	CofetarieOnline co1;
	float* salarii = new float[3] {100, 200, 300};
	CofetarieOnline co2("Cofetarie.ro", 4, "Cofetarie", 3, salarii, 1, 2014, 10);
	...
	cout << "Nr mediu de angajati pt fiecare colaborator: " << co2.getNrMediuAngajatiPerColaborator();
