...
public:
	ComplexComercial() {
		this->cofetarie = new Cofetarie("Delicii", 3, 1, 2024, 20);
	...
	ComplexComercial(Magazin mag, Cofetarie* cof, int nrMasini, Masina* masini) {
		this->magazin = mag;
		this->cofetarie = new Cofetarie(*cof); // paranteza rotunda pt ca avem un sg obiect! *cof pt dereferentiere
	...
	ComplexComercial(const ComplexComercial& cc) {
		...
		this->cofetarie = new Cofetarie(*(cc.cofetarie)); // paranteza rotunda pt ca avem un sg obiect! *cof pt dereferentiere
	...
	friend ostream& operator<<(ostream& out, const ComplexComercial& cc) {
		out << "Magazinul din complexul comercial: " << cc.magazin << endl;
		out << "Cofetaria din complexul comercial: " << *cc.cofetarie << endl;
		out << "Avem " << cc.nrMasiniParcate << " masini parcate in complex: ";
		for (int i = 0; i < cc.nrMasiniParcate; i++) {
