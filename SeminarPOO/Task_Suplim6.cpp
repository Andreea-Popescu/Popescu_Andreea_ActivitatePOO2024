...
int main() {
    Telefon t1("Galaxy S21", 3, "Samsung", 4000);
    Telefon t2("Galaxy Flip5", 5, "Samsung", 5000);

    Magazin magazin("Magazin Telefoane", "Str. Straduta, Nr. 10", 10, 5, 15000);

    magazin.adaugaTelefon(t1);
    magazin.adaugaTelefon(t2);

    cout << magazin;

    Telefon t3("Galaxy Note7", 2, "Samsung", 3000);
    magazin = magazin + t3;

    cout << endl << "Dupa adaugarea unui telefon nou:" << endl;
    cout << magazin;
